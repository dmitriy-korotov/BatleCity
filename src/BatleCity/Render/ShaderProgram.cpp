...
ShaderProgram& ShaderProgram::operator=(
    ShaderProgram&& outher_shader_program) noexcept {
...
// PRIVATE
bool ShaderProgram::CreateShader(const std::string& source_code,
                                 const GLuint type_shader, GLuint& shader_ID) {

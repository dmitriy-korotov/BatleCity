...
Texture2D::SubTexture2D::SubTexture2D()
    : left_bottom_uv(0.f, 0.f), right_top_uv(1.f, 1.f) {}

Texture2D::SubTexture2D::SubTexture2D(const glm::vec2& _left_bottom_uv,
...
Texture2D::Texture2D(const GLboolean* pixels, const GLuint width,
                     const GLuint height, const GLuint channels,
                     const GLuint filter, const GLuint wrap_mode)
...
const Texture2D::SubTexture2D& Texture2D::getSubTexture(
    const std::string& subTexture_name) const {

...
class Tank : public IDynamicGameObject {
 public:
  ...
  Tank(ETankType tank_type, const glm::vec2& position, const glm::vec2& size,
       double max_velocity, double delay_between_shots = 200,
 ...
 private:
  ...
  inline static std::vector<std::string> m_all_kinds_tank_sprites = {
      ...
      "yellowTank3AnimatedSprite", "yellowTank4AnimatedSprite",
      "whiteTank1AnimatedSprite",  "whiteTank2AnimatedSprite",
      "whiteTank3AnimatedSprite",  "whiteTank4AnimatedSprite",
      "greenTank1AnimatedSprite",  "greenTank3AnimatedSprite",
      "greenTank4AnimatedSprite",  "greenTank4AnimatedSprite",
      "greenTank5AnimatedSprite",  "greenTank6AnimatedSprite",
      "greenTank7AnimatedSprite",  "greenTank8AnimatedSprite",
      "redTank1AnimatedSprite",    "redTank2AnimatedSprite",
      "redTank3AnimatedSprite",    "redTank4AnimatedSprite"};
};
}  // namespace BatleCity

...
namespace BatleCity {
IDynamicGameObject::IDynamicGameObject(EGameObjectType game_object_type,
                                       const glm::vec2& position,
                                       const glm::vec2& size, float rotation,
                                       float layer, const glm::vec2& direction,
...
void IDynamicGameObject::move(const glm::vec2& offset) { m_position += offset; }
...
double IDynamicGameObject::getMaxVelocity() const { return m_max_velocity; }
